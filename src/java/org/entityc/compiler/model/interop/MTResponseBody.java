...
public class MTResponseBody extends MTNode implements MTReferenceResolution, MTTemplateSupport {
    ...
    public MTResponseBody(ParserRuleContext ctx) {
        super(ctx);
    }
    ...
    public boolean resolveReferences(MTSpace space, int pass) {
        //ECLog.logInfo("Resolving BODY references in RESPONSE");
        boolean anotherPass = false;
        if (domain == null) {
            //ECLog.logInfo("Resolving DOMAIN references in RESPONSE : " + domainName);
        ...
        if (entity == null) {
            //ECLog.logInfo("Resolving ENTITY references in RESPONSE : " + entityName);
        ...
        if (entity != null) {
            if (domainView == null) {
                // TODO make this work
                //ECLog.logInfo("Resolving VIEW references in RESPONSE : " + viewName);
            }
        }
        return anotherPass;
    }
